...
$sqlSoLuongKhoaHoc = "select count(*) as SoLuong from `khoahoc`";
//3. Thực thi câu truy vấn SQL để lấy về dữ liệu
$result = mysqli_query($conn, $sqlSoLuongKhoaHoc);
