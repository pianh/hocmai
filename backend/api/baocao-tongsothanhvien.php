...
$sqlSoLuongThanhVien = "select count(*) as SoLuong from `thanhvien`";
//3. Thực thi câu truy vấn SQL để lấy về dữ liệu
$result = mysqli_query($conn, $sqlSoLuongThanhVien);
