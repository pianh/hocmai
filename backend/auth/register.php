...
<head>
    ...
    <title>Đăng ký tài khoản | LearnForever.xyz</title>
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-12 ml-sm-auto px-4 mb-2 distance">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Đăng ký tài khoản tại LearnForever.xyz để được hưởng nhiều quyền lợi</h1>
                </div>
                <!-- Block content -->
                <?php
                                        ...
                                        <div class="card-footer p-4">
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <a class="btn btn-primary form-control input-register-height" href="/learnforever.xyz/backend/auth/login.php">Đăng nhập</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
