...
";
//3. Thực thi
$resultSelectBAIGIANG = mysqli_query($conn, $sqlSelectVIDEO);
//4. Phân tách thành mảng array
$rowBaigiangKhoaHocMuonXoa = mysqli_fetch_array($resultSelectBAIGIANG, MYSQLI_ASSOC);
//5. Xóa FILE ẢNH TRÁNH RÁC
$filePath = __DIR__ . '/../../assets/uploadsbaigiang/' .$rowBaigiangKhoaHocMuonXoa['bg_tentaptin'];
unlink($filePath);
