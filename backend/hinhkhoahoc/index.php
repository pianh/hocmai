...
<head>
    ...
    <title>Danh sách hình khóa học</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                //2. Chuẩn bị câu lệnh
                $sql = "
                SELECT hkh.hkh_ma, hkh.hkh_tentaptin, kh.kh_tenkhoahoc
                FROM hinhkhoahoc hkh
                JOIN khoahoc kh ON hkh.kh_makhoahoc = kh.kh_makhoahoc;";
                //3. Thuc thi
                $result = mysqli_query($conn, $sql);
                //4. Phân tách thành mảng array
                $data = [];
                ...
                //  die;
                ?>
                <a href="create.php" class="btn btn-success">Thêm hình đại diện cho khóa học</a>
                <br />
                <br />
                <table class="table table-bordered table-hover">
                    ...
                    <?php foreach($data as $h): ?>
                        <tr>
                            <td><?= $h['hkh_ma'] ?></td>
                            <td>
                                <img src="/learnforever.xyz/assets/uploads/<?= $h['hkh_tentaptin'] ?>" class="hinh-kh">    
                            </td>
                            <td><?= $h['kh_tenkhoahoc'] ?></td>
                            <td>
                                <a href="edit.php?hkh_ma=<?= $h['hkh_ma'] ?>" class="btn btn-warning">Sửa</a>
                                <!-- <a href="delete.php?hkh_ma=<?= $h['hkh_ma'] ?>" class="btn btn-danger">Xóa</a> -->
                                <button type="button" class="btn btn-danger btnDelete" data-hkh_ma="<?= $h['hkh_ma'] ?>">
                                    Xóa
                                </button>
                            </td>
                        </tr>
       ...
       swal({
           ...
           .then((willDelete) => {
               if (willDelete) { // Nếu đồng ý xóa
                   ...
                   var hkh_ma = $(this).data('hkh_ma');
                   var url = "delete.php?hkh_ma=" + hkh_ma;
