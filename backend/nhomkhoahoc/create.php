...
<head>
    ...
    <title>Thêm mới nhóm khóa học</title>
...
<body>
    ...
    <div class="container-fluid" style="padding-bottom: 320px;">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <h1>Thêm mới nhóm khóa học</h1>
                <form name="frmCreate" id="frmCreate" method="post" action="">
                    Tên nhóm khóa học (*):
                    <br/>
                    <input type="text" name="nkh_ten" id="nkh_ten" class="form-control"/>
                    <br />

                    Mô tả nhóm khóa học:
                    <textarea name="nkh_mota" id="nkh_mota" class="form-control"></textarea>
                    <br/>
                ...
                if(isset($_POST['btnSave'])) {
                    ...
                    include_once __DIR__ . '/../../dbconnect.php';
                    //2. chuẩn bị câu lệnh
                    $ten = htmlentities ($_POST['nkh_ten']);
                    $mota = htmlentities ($_POST['nkh_mota']);
                    $sql = "INSERT INTO nhomkhoahoc(nkh_ten, nkh_mota) VALUES ('$ten', '$mota');";
                    //debug
                    // var_dump($sql);
                    // die;
