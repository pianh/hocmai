...
<body>
    ...
    <div class="container-fluid pd-bottom-380 ">
        <div class="row">
            ...
            <h1>Xóa nhóm khóa học</h1>
            <?php
            $maMuonXoa = $_GET['nkh_ma'];
            ?>
            ...
            <form name="frmCreate" id="frmCreate" method="post" action="">
                Mã/ID nhóm khóa học (*):
                <br/>
                <input type="text" name="nkh_ma" id="nkh_ma" readonly
                value="<?= $maMuonXoa ?>"
                />
                <br /></br>
            ...
            if(isset($_POST['btnSave'])) {
                ...
                //2. chuẩn bị câu lệnh
                $ma = $_POST['nkh_ma'];
                $sql = "DELETE FROM nhomkhoahoc WHERE nkh_ma = $ma;";
