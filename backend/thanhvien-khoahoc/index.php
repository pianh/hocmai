...
<body>
    ...
    <div class="container-fluid" style="padding-bottom: 250px;">
        <div class="row">
            ...
            <h1>Danh sách thành viên với các khóa học hiện có</h1>
            <?php
                ...
                <a href="create.php" class="btn btn-primary">Thêm mới</a>
                    ...
                    <?php foreach($data as $tv_kh): ?>
                        <tr>
                            <td><?= $tv_kh['tv_kh_ma']  ?>  </td>
                            <td><?php echo $tv_kh['tv_tendangnhap']  ?></td>
                            <td><?php echo $tv_kh['tv_ten']  ?></td>
                            <td><?php echo $tv_kh['kh_tenkhoahoc']  ?></td>
                            <td>
                                <!-- Nút sửa -->
                                <a href="edit.php?tv_kh_ma=<?= $tv_kh['tv_kh_ma']?>" class="btn btn-warning">Sửa</a>
                                <!-- Nút xóa -->
                                <!-- <a href="delete.php?tv_kh_ma=<?= $tv_kh['tv_kh_ma']?>" class="btn btn-danger">Xóa</a> -->
                                <button type="button" class="btn btn-danger btnDelete" data-tv_kh_ma="<?= $tv_kh['tv_kh_ma'] ?>">
                                    Xóa
                                </button>
