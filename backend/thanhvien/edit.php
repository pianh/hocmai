        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <?php
                    ...
                    $idmuonsua = $_GET['tv_tendangnhap'];
                    //1. Mở kết nối
                    include_once __DIR__ . '/../../dbconnect.php';
                    //2. Chuẩn bị câu lệnh
                    $sqlSelect = <<<EOT
                    SELECT tv_tendangnhap, tv_ten, tv_gioitinh, tv_trangthai, tv_giaovien
                    FROM thanhvien
                    WHERE tv_tendangnhap = '$idmuonsua';
EOT;
                    //3. Thực thi
                ...
                <form name="frmCreate" id="frmCreate" method="post" action="">
                        ...
                        Tên thành viên (*):
                        <br/>
                        <input type="text" name="tv_ten" id="tv_ten"
                            value="<?= $dataDongMuonSua['tv_ten'] ?>"
                        class="form-control"
                        />
                        <br />
                ...
                <?php
                    ...
                    if(isset($_POST['btnSave'])) {
                        ...
                        $ten = $_POST['tv_ten'];
                        $gioitinh = $_POST['tv_gioitinh'];
                        $trangthai = $_POST['tv_trangthai'];
                        $giaovien = $_POST['tv_giaovien'];
                        //Heredoc
                        $sql = <<<EOT
                        UPDATE thanhvien
                        SET  tv_ten='$ten', tv_gioitinh= $gioitinh,
                        tv_trangthai= $trangthai, tv_giaovien= $giaovien
                        WHERE tv_tendangnhap= '$tendangnhap';
EOT;
                        // debug
                        // var_dump($sql);
                        // die;
