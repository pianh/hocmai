...
";
//3. Thực thi
$resultSelectVIDEO = mysqli_query($conn, $sqlSelectVIDEO);
//4. Phân tách thành mảng array
$rowVideoKhoaHocMuonXoa = mysqli_fetch_array($resultSelectVIDEO, MYSQLI_ASSOC);
//5. Xóa FILE ẢNH TRÁNH RÁC
$filePath = __DIR__ . '/../../assets/uploadsvideo/' .$rowVideoKhoaHocMuonXoa['video_tentaptin'];
unlink($filePath);
//6. Chuẩn bị câu lệnh DELETE
$sqlSelectHSP = "
    DELETE FROM videokhoahoc
    WHERE video_ma= $video_ma;
    ";
//7. Thực thi
