    ...
    <div class="container-fluid" style="padding-bottom: 250px;">
        <div class="row">
            ...
            <div class="col-md-10 pd-bottom-150">
                ...
                <h1>XUẤT BÁO CÁO DANH SÁCH THÀNH VIÊN</h1>
                </br>
                <?php
                ...
                <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            <td> 
                                <a href="/learnforever.xyz/backend/xuatbaocao/thanhvien/thuvien-word.php" class="btn btn-success" target="_blank">Xuất Word</a>
                                </br></br>
                                <a href="/learnforever.xyz/assets/templates/word/danhsachthanhvien.docx">Tải File Word danh sách thành viên</a>
                            </td>
                        
                            <td> 
                                <a href="/learnforever.xyz/backend/xuatbaocao/thanhvien/thuvien-pdf.php" class="btn btn-success" target="_blank">Xuất PDF</a>
                                </br></br>
                                <a href="/learnforever.xyz/backend/xuatbaocao/thanhvien/thuvien-pdf.php" target="_blank">Tải File PDF danh sách thành viên</a>
                            </td>
