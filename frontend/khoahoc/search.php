...
<body class="d-flex flex-column h-100">
    ...
    <main role="main" class="mb-2">
        ...
        // $noidungsearch = $_POST['noidung'];
        $noidungsearch = $_GET['noidungsearch'];
        // echo $noidungsearch;
        // 2. Chuẩn bị câu truy vấn $sql


       $sqlDanhSachKhoaHoc = <<<EOT
         SELECT distinct kh.kh_makhoahoc, kh.kh_tenkhoahoc, kh.kh_hocphi, kh.kh_hocphicu, kh.kh_mota_ngan, kh.kh_mota_chitiet, nkh.nkh_ten, hkh.hkh_tentaptin
         FROM `khoahoc` kh
         JOIN `nhomkhoahoc` nkh ON kh.nkh_ma = nkh.nkh_ma
         JOIN `hinhkhoahoc` hkh ON kh.kh_makhoahoc = hkh.kh_makhoahoc
         WHERE (kh.kh_tenkhoahoc LIKE '%$noidungsearch%') OR  (kh.kh_hocphi LIKE '%$noidungsearch%' )
         OR (kh.kh_mota_ngan LIKE '%$noidungsearch%') OR (kh.kh_mota_chitiet LIKE '%$noidungsearch%')
        OR (nkh.nkh_ten LIKE'%$noidungsearch%');
 ...
 EOT;
        ...
        ?>
         ...
         <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">Danh sách khóa học đã tìm thấy</h1>
            ...
            <div id="th" class="main-thpt">
                <div class="container">
                    <div class="row no-mg aos-init aos-animate " data-aos="fade-up">
                        <div class="box-title-thpt" style="margin-bottom: 30px; font-size: 2rem;">Học tại LearnForever để phát triển bản thân </div>
